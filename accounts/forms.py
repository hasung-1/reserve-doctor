...
class HospitalSignUpForm(UserCreationForm):
    ...
    sido = forms.CharField(max_length=20,widget=forms.HiddenInput(attrs={"id":"sido"}),required=False)
    gungu = forms.CharField(max_length=20,widget=forms.HiddenInput(attrs={"id":"gungu"}),required=False)
    dong = forms.CharField(max_length=20,widget=forms.HiddenInput(attrs={"id":"dong"}),required=False)
    addr = forms.CharField(max_length=50,widget=forms.HiddenInput(attrs={"id":"addr"}),required=False)
    addr_rest = forms.CharField(max_length=50,widget=forms.HiddenInput(attrs={"id":"addr_rest"}),required=False)
